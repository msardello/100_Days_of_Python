...
def compare(user_final_score, computer_final_score):
    ...
    if user_final_score == computer_final_score:
        ...
        return "Game Over! Computer has a Blackjack and wins! 😱"
    elif user_final_score == 0:
        return "Game Over! You have a Blackjack and win! 😎"
    elif user_final_score > 21:
        return "Game Over! You busted and you lose! 😭"
    elif computer_final_score > 21:
        return "Game Over! Computer busted and you win! 😁"
    elif user_final_score > computer_final_score:
        return "Game Over! You have the high score and win! 😃"
    else:
        return "Game Over! Computer has the high score and wins! 😤"
